...
function theme_custom_setup() {
    ...
    add_image_size( "example_thumb", 1080, 1080, true );
    add_image_size( "blog_thumb", 1080, 1080, true );
    add_image_size( "instagram_thumb", 1080, 1080, true );
    add_image_size( "medium", 1080, 800, true );
    add_image_size( "thumb", 1080, 1080, true );
    add_image_size( "small", 1080, 1080, true );
...
function custom_get_news_posts() {
    global $post;
    ob_start();
    ...
    <?php if( $post_query->have_posts() ) : ?>
        <?php while( $post_query->have_posts() ) : $post_query->the_post();
            $title = mb_strimwidth(strip_tags($post->post_title), 0, 50, "…", "UTF-8");
            $cat = get_the_terms($post->ID, "blog_category");

   <div class="my-[60px] h-px w-full bg-gray-300"></div>
      ...
      <footer class="mx-[6vw] grid md:grid-cols-3 grid-cols-1">
        ...
        <div class="grid grid-cols-8">
          ...
          <div class="col-span-7 text-[15px] leading-[40px] md:mt-[50px]">
            ...
            <div class="ml-[1.5vw] mt-[20px]">
            <div>
              <a href="<?php echo esc_url(home_url('/')); ?>assets#component#Notice" class="footer-button">
                  お知らせ
              </a>
            </div>
            <div>
            ...
            <div> 
              <a href="<?php echo esc_url(home_url('/')); ?>assets#component#Menu" class="footer-button">
                メニュー
              </a>
            </div> 
            <div> 
              <a href="<?php echo esc_url(home_url('/')); ?>assets#component#Infor" class="footer-button">
                店舗情報
              </a>
            </div> 
            <div> 
              <a href="<?php echo esc_url(home_url('/')); ?>assets#component#Inside" class="footer-button">
                店内案内
              </a>
            </div> 
            <div> 
              <a href="<?php echo esc_url(home_url('/')); ?>assets#component#Contact" class="footer-button">
                お問い合わせ
              </a>
            </div> 
            </div>

...
<form id="contactForm" method="post">
  ...
  <div class="mt-[60px]">
    ...
    <input id="name" name="name" type="text" placeholder="例）商工 太郎"
  ...
  <div class="mt-[60px]">
    ...
    <input id="phone" name="phone" type="text" placeholder="例）000-0000-0000"
      class="placeholder-[#665B09]/50 mt-[5px] w-full h-[60px] text-[15px] py-[10px] px-[20px] border border-[#665B09]/50 focus:border-blue-500 focus:outline-none transition-colors duration-300"/>
  ...
  <div class="mt-[60px]">
    ...
    <input id="email" name="email" type="text" placeholder="例）example@gmail.com"
      class="placeholder-[#665B09]/50 mt-[5px] w-full h-[60px] text-[15px] py-[10px] px-[20px] border border-[#665B09]/50 focus:border-blue-500 focus:outline-none transition-colors duration-300"/>
  ...
  <div class="mt-[60px]">
    ...
    <textarea id="message" name="message"
      class="mt-[5px] w-full h-[250px] text-[15px] py-[10px] px-[20px] border border-[#665B09]/50 focus:border-blue-500 focus:outline-none transition-colors duration-300 resize-none overflow-y-auto overflow-x-hidden"></textarea>
